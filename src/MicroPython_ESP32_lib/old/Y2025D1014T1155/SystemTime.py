...
if __name__ == "__main__":
  ...
  print("[__main__] init local time:", Time())
  try:
    ...
    print("[__main__] sync_ntp local time (UTC+0):", Time()) 
    print("[__main__] sync_ntp local time (UTC+8):", Time(timezone=8)) 
    offset(8)

    while True:
      utime.sleep_ms(500)
      print("[__main__] Current local time:", Time())
